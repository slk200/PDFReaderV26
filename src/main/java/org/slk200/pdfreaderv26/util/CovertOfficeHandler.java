 ...
 */
class CovertOfficeHandler {
    private static final Integer WORD_TO_PDF_OPERAND = 17;
    private static final Integer PPT_TO_PDF_OPERAND = 32;
    private static final Integer EXCEL_TO_PDF_OPERAND = 0;

    //WPS Office COM组件ProgID
    private static final String WPS_WORD_PROG_ID = "KWPS.Application";
    private static final String WPS_PPT_PROG_ID = "KWPP.Application";
    private static final String WPS_EXCEL_PROG_ID = "KET.Application";

    //Microsoft Office COM组件ProgID（未找到WPS时回退使用）
    private static final String MS_WORD_PROG_ID = "Word.Application";
    private static final String MS_PPT_PROG_ID = "PowerPoint.Application";
    private static final String MS_EXCEL_PROG_ID = "Excel.Application";
    ...
    static void word2pdf(String inFile, String outFile) {
        try {
            convertWord(WPS_WORD_PROG_ID, inFile, outFile);
        } catch (ComFailException e) {
            //未找到WPS组件，回退到Microsoft Word
            try {
                convertWord(MS_WORD_PROG_ID, inFile, outFile);
            } catch (Exception ex) {
                Logger.getLogger(CovertOfficeHandler.class.getName()).log(Level.WARNING, "MS office转word错误", ex);
            }
        } catch (Exception e) {
            Logger.getLogger(CovertOfficeHandler.class.getName()).log(Level.WARNING, "WPS office转word错误", e);
        }
    }

    private static void convertWord(String progId, String inFile, String outFile) {
    ...
    static void ppt2pdf(String inFile, String outFile) {
        try {
            convertPpt(WPS_PPT_PROG_ID, inFile, outFile);
        } catch (ComFailException e) {
            //未找到WPS组件，回退到Microsoft PowerPoint
            try {
                convertPpt(MS_PPT_PROG_ID, inFile, outFile);
            } catch (Exception ex) {
                Logger.getLogger(CovertOfficeHandler.class.getName()).log(Level.WARNING, "MS office转ppt错误", ex);
            }
        } catch (Exception e) {
            Logger.getLogger(CovertOfficeHandler.class.getName()).log(Level.WARNING, "WPS office转ppt错误", e);
        }
    }

    private static void convertPpt(String progId, String inFile, String outFile) {
        ActiveXComponent activeXComponent = null;
        Dispatch wpp = null;
        try {
            ComThread.InitSTA();
    ...
    static void excel2pdf(String inFile, String outFile) {
        try {
            convertExcel(WPS_EXCEL_PROG_ID, inFile, outFile);
        } catch (ComFailException e) {
            //未找到WPS组件，回退到Microsoft Excel
            try {
                convertExcel(MS_EXCEL_PROG_ID, inFile, outFile);
            } catch (Exception ex) {
                Logger.getLogger(CovertOfficeHandler.class.getName()).log(Level.WARNING, "MS office转excel错误", ex);
            }
        } catch (Exception e) {
            Logger.getLogger(CovertOfficeHandler.class.getName()).log(Level.WARNING, "WPS office转excel错误", e);
        }
    }

    private static void convertExcel(String progId, String inFile, String outFile) {
        ActiveXComponent activeXComponent = null;
        Dispatch et = null;
        try {
            ComThread.InitSTA();
